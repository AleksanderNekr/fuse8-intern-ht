...
namespace Fuse8_ByteMinds.SummerSchool.InternalApi.Data.Migrations
{
    ...
    [Migration("20230902170556_Move_CurrenciesSettings_to_DB")]
    partial class Move_CurrenciesSettings_to_DB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fuse8_ByteMinds.SummerSchool.InternalApi.Models.Settings.CurrenciesSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("MinAvailableYear")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("settings", "cur", t =>
                        {
                            t.HasCheckConstraint("currency_enum_range_ch", "base_currency IN ('EUR', 'KZT', 'RUB', 'USD')");
